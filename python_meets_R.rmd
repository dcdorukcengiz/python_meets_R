...
Say, you have built a forecast model, and you get the following forecasts at state-by-month-level. Could you pivot this data from long to wide format? Each row will show the state information.     
